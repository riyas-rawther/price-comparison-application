  ...
  <body>
    ...
    <div id="wrap">
      ...
      <div class="container">
        ...
        <form class="form" id="form" target="form-iframe"  method="post" action="addproduct.php" style="font-size: 13px; font-family: Verdana; width: 650px;">
     
   	
           <input style="width: 182px; margin-top: 5px;" placeHolder="Product Name" id="productname" name="productname" class="text-input" type="text" maxlength="16" /> 
           <div name="category" id="comboboxcategories"></div>
            <input style="width: 182px; margin-top: 5px;" placeHolder="Product Image Link" id="ProImage" name="ProImage" class="text-input" type="text" />
...
var dataAdapter = new $.jqx.dataAdapter(source);
		...
		$("#comboboxcategories").jqxComboBox(
		{
			source: dataAdapter,
