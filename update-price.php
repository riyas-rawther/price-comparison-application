...
//color combobox
 var colors = [
                ...
                $("#comboBoxColor").jqxComboBox({  source: colors,selectedIndex: 0, width: 200, height: 25});
                // Focus jqxComboBox
...
//network combobox
 var network = [
                ...
                // Create a jqxComboBox
                $("#comboBoxnetwork").jqxComboBox({  source: network, selectedIndex: 0, width: 200, height: 25});
                // Focus jqxComboBox
...
//memorycombobox
 var memory = [
                ...
                // Create a jqxComboBox
                $("#comboBoxMemory").jqxComboBox({  source: memory, selectedIndex: 0, width: 200, height: 25});
                // Focus jqxComboBox
